...
import { Users, HomeIcon, BookOpen, Coins, TrendingUp, AlertCircle } from 'lucide-react'
...
async function fetchDashboardStats(): Promise<DashboardStats> {
  const [members, families, cases, expenses, collections] = await Promise.all([
...
const statCards: StatCard[] = [
  ...
  { key: 'totalFamilies',      icon: HomeIcon,      color: 'text-green-500',   bg: 'bg-green-500/10' },
