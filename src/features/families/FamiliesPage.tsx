    ...
    <div className="space-y-4 pb-4">
                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((family) => (
                      <TableRow key={family.id}>
                        ...
                        <TableCell>
                          {family.village && (
                            <Badge variant="secondary">{family.village}</Badge>
                          )}
                        </TableCell>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Delete <strong>{family.family_name}</strong>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="w-[calc(100vw-2rem)] sm:w-full max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editing ? t("family.editFamily") : t("family.addFamily")}
            </DialogTitle>
          </DialogHeader>
          <form
          ...
          >
            <div className="space-y-2">
              <Label>
                {t("family.familyName")} <span className="text-destructive">*</span>
              </Label>
